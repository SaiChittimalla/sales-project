                                            ...
                                            <div class="padding-div border-top-0 ">
                                                <div class="">
                                                    ...
                                                    <input type="text" class="form-control " name="Name" id="Name"
                                                        ...
                                                        v-model="this.formData.Firstname" required />
                                                </div>
                                            </div>
                                        ...
                                        <div class="card input-cards ">
                                            <div class="padding-div border-top-0 ">
                                                <div class="">
                                                    ...
                                                    <input type="text" class="form-control  " name="Name" id="Name"
                                                        aria-describedby="helpId" placeholder=""
                                                        v-model="this.formData.mobileNumber" required />
                                                </div>
                                            </div>

                                            <div class="padding-div">
                                                <div class="">
                                                    <label for="Name" class="form-label text-muted">Mail ID</label>
                                                    <input type="email " class="form-control  " name="Name" id="Name"
                                                        aria-describedby="helpId" placeholder=""
                                                        v-model="this.formData.mail" />
                                                </div>
                                            </div>

                                            <div class="padding-div">
                                                <div class="">
                                                    <label for="Name" class="form-label text-muted"> Whatsapp number
                                                    </label>
                                                    <input type="text" class="form-control  " name="Name" id="Name"
                                                        aria-describedby="helpId" placeholder=""
                                                        v-model="this.formData.whatsappNumber" />
                                                </div>
                                            </div>
                                            <div class="padding-div">
                                                <div class="">
                                                    ...
                                                    <input type="text" class="form-control  " name="Name" id="Name"
                                                        aria-describedby="helpId" placeholder=""
                                                        v-model="this.formData.alternativeNumber" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="padding-div border-top-0 ">
                                                <div class="">
                                                    ...
                                                    <input type="text" class="form-control" name="" id=""
                                                        aria-describedby="helpId" placeholder=""
                                                        v-model="this.formData.organization" />
                                        ...
                                        <div>
                                            <div class="my-2">
                                                <input type="radio" class="btn-check " name="btnradio-1" id="btnradio1"
                                                    v-model="this.formData.leadorg" v-bind:value="'Client'"
                                                    autocomplete="off">
                                            ...
                                            <div class="my-2">
                                                <input type="radio" class="btn-check" name="btnradio-1" id="btnradio2"
                                                    v-model="this.formData.leadorg" v-bind:value="'Channel_Partner'"
                                                    autocomplete="off">
                                ...
                                <div class=" d-flex justify-content-center ">
                                    <div class="m-2 organization data-height">
                                        <div class="">
                                            ...
                                            <div class="oraganizations " role="group"
                                                ...
                                                <div class=" row">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Campaign'"
                                                            id="btnradio12" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio12">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/material-symbols_camping-outline.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization"
                                                            v-bind:value="'Cold_Calling'" id="btnradio13"
                                                            autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio13">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/tdesign_service.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Vendor'"
                                                            id="btnradio14" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio14">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/icon-park-solid_manual-gear.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                                    <h4 class="contact-through">Customer’s
                                                                        Vendor</h4>
                                                                </div>
                                                            </div>
                                                        </label>
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Exhibition'"
                                                            id="btnradio15" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio15">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/tdesign_museum-1.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization"
                                                            v-bind:value="'Existing Customer'" id="btnradio16"
                                                            autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio16">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/mingcute_building-2-line.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                                    <h4 class="contact-through">Existing Customer</h4>
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Mailing'"
                                                            id="btnradio17" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio17">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/ri_mail-send-fill.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Reference'"
                                                            id="btnradio18" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio18">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/ic_baseline-search.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization"
                                                            v-bind:value="'Supplier_Reference'" id="btnradio19"
                                                            autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio19">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/clarity_users-line.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                                                    <h4 class="contact-through">Supplier
                                                                        Reference</h4>
                                                                </div>
                                                            </div>
                                                        </label>
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        <input type="radio" class="btn-check" name="btnradio"
                                                            v-model="this.formData.organization" v-bind:value="'Walk-in'"
                                                            id="btnradio20" autocomplete="off">
                                                        <label class="btn h-100 btn-primary bg-check-none "
                                                            for="btnradio20">
                                                            <div>
                                                                <div class=" text-center py-4  ">
                                                                    <img src="../../../../assets/healthicons_walking-outline.svg"
                                                                        alt="img-fluid">
                                                                </div>
                                                                <div class=" card-body px-0 py-2 text-center ">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-3 cat-div">
                                                <div class="">
                                                    <input type="radio" class="btn-check" name="categoryradio"
                                                        v-model="this.formData.category" v-bind:value="'Product_Enquiry'"
                                                        id="btnradio22" autocomplete="off">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-3 cat-div">
                                                <div class="">
                                                    <input type="radio" class="btn-check" name="categoryradio"
                                                        v-model="this.formData.category" v-bind:value="'Information'"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-3 cat-div">
                                                <div class="">
                                                    <input type="radio" class="btn-check" name="categoryradio"
                                                        v-model="this.formData.category" v-bind:value="'Suggestions'"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 mb-3 cat-div">
                                                <div class="">
                                                    <input type="radio" class="btn-check" name="categoryradio"
                                                        v-model="this.formData.category" v-bind:value="'Other'"
