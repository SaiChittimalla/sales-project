        ...
        <div class="shadow-lg">
          <h6 class="fw-bold py-2">
            <router-link to="/completedata" class="text-decoration-none"
              ><i class="bi bi-arrow-left me-2 mt-5"></i></router-link
            >New Quotation - Lead
          </h6>
        </div>
      </div>
                ...
                <ul v-show="isOpen" class="ul-tag w-100 ms-2">
                  ...
                  <li>
                    <div>
                      ...
                      >
                        <i class="bi bi-plus new-lead-icon me-2 fw-bold"></i>Add
                        New Lead
                      </button>
                      <div
                      ...
                      >
                        <div class="offcanvas-header">
                          <h5
                            class="offcanvas-title new-lead-offcanvas"
                          ...
                          <div class="row">
                            <div class="col-4">
                              <div class="text-end">
                                <button
                                  type=" reset"
                                  class="btn border-0 cancel-btn mt-2"
                                >
                                  Cancel
                                </button>
                              </div>
    ...
    <div>
      <nav class="navbar header shadow-sm">
        <div class="container w-100">
          <h6 class="fw-bold">
            <span class=""
              ><i @click="backSide()" class="bi bi-arrow-left me-2"> </i>New
              Quotation - lead</span
            >
          </h6>
        </div>
            ...
            <div>
              <div class="card card1 mt-4">
                <div class="card-header border-bottom-0">
                  <div
                    class="d-flex justify-content-between py-2 px-1 align-items-center"
                  >
                    <div>
                      <h6 class="m-2 label-name">Product</h6>
                      <p class="text-secondary ms-2 m-0 product">
              ...
              <div class="d-flex justify-content-end mt-3 positionbtn mb-1">
                <div class="mt-2 mb-2">
                  <button class=" border-0 m-0 btndraft text-white " @click="saveDraft()">Save</button>
                </div>
                <!-- <div class="mt-2 mb-2">
                  <button
...
export default {
  ...
  methods: {
    ...
    //     (this.savedData.items = this.arr), console.log(this.savedData);
    //     axios
    //       .put(
    //         ApiUrls.resource +
    //           "/" +
