      ...
      <div class="pt-3">
        <div class="card card1 p-4">
          ...
          <p style="font-size: 13px">
            Customer Name :-
            <span class="text-muted">{{ currentEmployee.customer_name }}</span>
          </p>
          <div>
            <p style="font-size: 13px">
              Mobile NO :-
          ...
          <div class="">
            <p style="font-size: 13px">
              Billing Address:<br /><span class="text-muted">{{
                removeBrTags(currentEmployee.shipping_address)
              }}</span>
            </p>
            <p style="font-size: 13px">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center gap-2">
                  <button class="btn border-1 increment">
                    ...
                    <h6>
                      <span id="count" :v-model="currentEmployee.items">{{
                        item.qty
                      }}</span>
                    </h6>
                    <button
    ...
    <div>
      ...
      <div class="container">
        <div class="bg-1">
          ...
          <div class="inputheader mt-3 p-2">
            <h6 class="m-2 label-name">Delivery date</h6>
            <p v-show="!date" class="formdata mt-3 ms-2 mb-4">
              {{ DeliveryData.delivery_date }}
            </p>
          </div>
...
export default {
  ...
  methods: {
    ...
    sales() {
      (this.salesorder = true), (this.show1 = false);
    },
    fetchSales() {
      this.loading = true;
      let queryParams = {
      ...
      axios
        ...
        .then((quotationResponse) => {
          ...
          if (this.fullCustomerData.tax_category == "Out-State") {
            ...
            console.log("out state===", this.fullCustomerData);
          } else {
    ...
    mySubmit() {
      ...
      if (!this.selectedCustomer) {
        alert("Please select a items before submitting.");
        return;
      }
    ...
    //     this.savedData.party_name = this.selectedCustomer.customer_name;
